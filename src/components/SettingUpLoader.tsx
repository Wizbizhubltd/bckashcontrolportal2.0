...
/**
 * Full-screen loader shown between a successful OTP verification and landing on the dashboard —
 * covers the summary prefetch so the first screen never renders against half-loaded counts.
 */
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-primary font-body">
      ...
      >
        ...
        <div className="relative w-12 h-12">
          <motion.span className="absolute inset-0 rounded-full border-4 border-white/20" />
          <motion.span
